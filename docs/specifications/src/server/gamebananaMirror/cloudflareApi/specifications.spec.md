...
Integrates with Cloudflare API for caching and delivery of GameBanana content.

Tags: cloudflare, cdn, caching

- Uses Cloudflare as a CDN for GameBanana content
