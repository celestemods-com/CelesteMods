...
Defines the behavior of API routes in the Pages Router.

Tags: api, routes, server

- API routes follow RESTful principles
- Routes handle appropriate HTTP methods
- Routes include proper error handling
