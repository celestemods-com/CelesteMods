...
Components for filter popover UI elements used in search functionality.

Tags: filters, popovers, search

- Provides UI elements for filtering content
- Implements popover behavior for filter controls
