...
import { TechDropdownHeader } from "./TechDropdownHeader";
...
export const TechDropdown = ({ modID, gamebananaModID }: { modID: number, gamebananaModID: number }) => {
    ...
    if (imageUrlsArray.length) {
        return (
            <Stack>
                <TechDropdownHeader modID={modID} />
