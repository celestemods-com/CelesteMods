...
import { DifficultyDropdownHeader } from "./DifficultyDropdownHeader";
...
export const DifficultyDropdown = ({ modID, gamebananaModID }: { modID: number, gamebananaModID: number }) => {
    ...
    if (imageUrlsArray.length) {
        return (
            <Stack>
                <DifficultyDropdownHeader modID={modID} />
